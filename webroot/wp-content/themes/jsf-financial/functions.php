...
if ( ! function_exists( 'jsf_financial_setup' ) ) :
	...
	function jsf_financial_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'jsf-financial' ),
		) );
...
function jsf_financial_scripts() {
	...
	wp_enqueue_script( 'jsf-financial-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
